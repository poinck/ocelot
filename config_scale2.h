...
#define PANEL_WIDTH     128       /* 0 for no space for side-panel, thus
...
#define BORDER_WIDTH    8         /* window border width. choose 8 if you've
...
static const char *wermcmd[] = { "owterminal", NULL };
...
static Key keys[] = {
    ...
    {  MOD4|CONTROL,     XK_Return,     spawn,             {.com = wermcmd}},
