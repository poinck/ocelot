...
(
    echo "^pa(0;5) ^fg(#ffffff)$(date '+%a,')"
    echo " ^fg(#ffffff)$(date '+%H:%M')"
    echo "^pa(0;5) $(date '+%d. %b')"
    echo "^pa(;10)^fg(#e0a1ff)^r(75x8)^fg(#75507B)^ib(1)^pa(4;14)^r(67x4)"
    echo "^fg(#e0a1ff)^r(75x30)^fg(#75507B)^ib(1)^pa(4)^r(67x22)^pa(8)^fg(#ffffff)GLSA: 4"
    echo "^fg(#e0a1ff)^r(75x30)^fg(#75507B)^ib(1)^pa(4)^r(67x22)^pa(8)^fg(#ffffff)affected"
    ...
    echo " 20·"
    sleep 42
) | dzen2 -l 42 -h 18 -ta l -w 75 -fn "monospace:bold:size=9" -e 'onstart=uncollapse'
