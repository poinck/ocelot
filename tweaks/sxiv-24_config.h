 ...
 */
static const char * const BAR_FONT = "Monoid:pixelsize=15";

/* colors:
 * (see X(7) section "COLOR NAMES" for valid values)
 */
static const char * const WIN_BG_COLOR = "#1c1c1c";
static const char * const WIN_FS_COLOR = "#000000";
static const char * const SEL_COLOR    = "#fbf236";
static const char * const BAR_BG_COLOR = "#3f3f74";
